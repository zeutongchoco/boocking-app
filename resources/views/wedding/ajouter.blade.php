...
<div class="container ">
      ...
      <div class="row">
        ...
        <form action="/ajouter/traitement" method="POST" class="form-group">
           ...
           <br>
           <button type="submit" class="btn btn-primary">AJOUTER WEDDING_SHOOT</button>
           <br>
           </br>
           <a href="/wedding" class="btn btn-danger">Appercu liste wedding_shoot </a>
